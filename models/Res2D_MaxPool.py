"""
2-dimensional Residual Network with a max-pooling layer
"""
...
class Res2D_MaxPool(nn.Module):
    def __init__(self, nOUT, in_ch=1, out_ch=128):
        super(Res2D_MaxPool, self).__init__()
